...
/**
 * JPA-entiteit voor een extractie-taak in de verwerkingsqueue.
 */
@Entity
...
public class ExtractieTaak {
  ...
  public ExtractieTaakStatus getStatus() {
    return status;
  }

  public void setStatus(ExtractieTaakStatus status) {
    this.status = status;
  }
  ...
  public Integer getAantalBezwaren() {
    return aantalBezwaren;
  }
