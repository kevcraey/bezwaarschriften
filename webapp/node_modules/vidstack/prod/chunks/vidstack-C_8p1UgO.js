...
import { canOrientScreen, IS_IPHONE, isAudioSrc, canPlayAudioType, isVideoSrc, canPlayVideoType, isHLSSupported, isHLSSrc, isDASHSupported, isDASHSrc, IS_CHROME, IS_IOS, canGoogleCastSrc, canChangeVolume } from './vidstack-DyMkFGuS.js';
import { TimeRange, getTimeRangesStart, getTimeRangesEnd, updateTimeIntervals } from './vidstack-BmMUBVGQ.js';
import { isTrackCaptionKind, TextTrackSymbol, TextTrack } from './vidstack-B5628Ni3.js';
...
import { preconnect, getRequestCredentials } from './vidstack-vDnjyKV8.js';
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-kV1-bfkY.js');
