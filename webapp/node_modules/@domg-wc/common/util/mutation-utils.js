 ...
 */
export const onChildListChange = (toObserve, changeCallback) => {
    const mutationObserver = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
            if (mutation.addedNodes.length)
                changeCallback(mutation.addedNodes);
            if (mutation.removedNodes.length)
                changeCallback(mutation.removedNodes);
        });
    });
    mutationObserver.observe(toObserve, { childList: true });
    return mutationObserver;
};
//# sourceMappingURL=mutation-utils.js.map