export class BaseHTMLElement extends HTMLElement {
     ...
     */
    constructor(html = null, styleSheets) {
        super();
    ...
    attributeChangedCallback(attr, oldValue, newValue) {
        ...
        classRef._observedClassAttributes
            ...
            .filter((attribute) => attribute == attr || attribute == BaseHTMLElement.attributePrefix + attr)
            .forEach((attribute) => {
        ...
        const getCallbackFunction = (attribute) => {
            ...
            return this[`_${splittedAttribute.shift()}${splittedAttribute
                .map(changeFirstLetterToUpperCase)
                .join('')}ChangedCallback`];
        };
        const callback = getCallbackFunction(attr) ||
    ...
    __changeAttribute(element, oldValue, newValue, attribute, classPrefix = null) {
...
//# sourceMappingURL=base.html.element.js.map