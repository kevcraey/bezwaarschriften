...
export class VlMapLayer extends BaseHTMLElement {
     ...
     */
    getStyleCount() {
        const childNodeList = this.querySelectorAll(':scope > *');
    ...
    _opacityChangedCallback(oldValue, newValue) {
...
//# sourceMappingURL=vl-map-layer.js.map