...
let VlMapMeasureAction = class VlMapMeasureAction extends VlMapDrawAction {
    constructor() {
        super();
...
VlMapMeasureAction = __decorate([
    webComponent('vl-map-measure-action'),
    __metadata("design:paramtypes", [])
], VlMapMeasureAction);
export { VlMapMeasureAction };
//# sourceMappingURL=vl-map-measure-action.js.map