...
let VlMapModifyAction = class VlMapModifyAction extends VlMapLayerAction {
...
VlMapModifyAction = __decorate([
    webComponent('vl-map-modify-action')
], VlMapModifyAction);
export { VlMapModifyAction };
//# sourceMappingURL=vl-map-modify-action.js.map