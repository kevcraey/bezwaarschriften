...
let VlMapBaseLayerGRBOrtho = class VlMapBaseLayerGRBOrtho extends VlMapBaseLayer {
    constructor() {
        super();
...
VlMapBaseLayerGRBOrtho = __decorate([
    webComponent('vl-map-baselayer-grb-ortho'),
    __metadata("design:paramtypes", [])
], VlMapBaseLayerGRBOrtho);
export { VlMapBaseLayerGRBOrtho };
//# sourceMappingURL=vl-map-base-layer-grb-ortho.js.map