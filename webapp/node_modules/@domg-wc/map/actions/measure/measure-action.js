...
export class VlMeasureAction extends VlDrawAction {
    ...
    _removeMeasurementTooltip(featureId) {
        ...
        this.measurementTooltips = this.measurementTooltips.filter((measurementTooltip) => this._getFeatureIdFor(measurementTooltip) !== featureId);
    }
...
//# sourceMappingURL=measure-action.js.map