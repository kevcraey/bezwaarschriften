...
let VlMap = VlMap_1 = class VlMap extends BaseHTMLElement {
    ...
    _dispatchLayerVisibleChangedEvent(layer) {
        this.dispatchEvent(new CustomEvent(EVENT.LAYER_VISIBLE_CHANGED, {
    ...
    _dispatchActiveActionChangedEvent(previousActiveAction, currentActiveAction) {
        this.dispatchEvent(new CustomEvent(EVENT.ACTIVE_ACTION_CHANGED, {
            detail: {
    ...
    __updateOverviewMapSizeOnLoad() {
        VlMap_1.__callOnceOnLoad(this.__updateOverviewMapSize.bind(this));
    }
    __updateMapSizeOnLoad() {
        VlMap_1.__callOnceOnLoad(this.__updateMapSize.bind(this));
    }
