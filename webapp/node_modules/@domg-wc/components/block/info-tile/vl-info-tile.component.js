...
let VlInfoTile = class VlInfoTile extends BaseHTMLElement {
    ...
    get _titleWrapperElement() {
        return this._element.querySelector('.vl-info-tile__title-wrapper');
    }
    get _titleElement() {
        return this._headerWrapperElement?.querySelector('#title');
    }
    get _titleSlot() {
        return this.querySelector(":scope > slot[name='title']");
    }
    get _titleLabelSlot() {
    ...
    get _buttonClickableElement() {
        return this._element?.querySelector('button.info-tile-clickable');
    }
    get _toggleElement() {
    ...
    get _footerElement() {
        return this._element.querySelector('footer');
    }
    get _footerSlotElement() {
        return this._element.querySelector('slot[name="footer"]');
    }
    get _badgeSlotElement() {
        return this._element.querySelector('slot[name="badge"]');
    }
    get _badgeWrapperElement() {
        return this._element.querySelector('.vl-info-tile__badge__wrapper');
    }
    get _iconElement() {
    ...
    _centerChangedCallback(oldValue, newValue) {
        if (newValue === null) {
    ...
    _fullHeightChangedCallback(oldValue, newValue) {
        if (newValue === null) {
    ...
    __prepareAccordionElements() {
        ...
        if (button)
            this._titleWrapperElement?.prepend(button);
    }
...
VlInfoTile = __decorate([
    webComponent('vl-info-tile'),
    __metadata("design:paramtypes", [])
], VlInfoTile);
export { VlInfoTile };
//# sourceMappingURL=vl-info-tile.component.js.map