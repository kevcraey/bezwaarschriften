export class ProzaRestClient {
    static getMessage(domain, code, options = {}, baseUrl) {
        const fetchOptions = {};
    ...
    static getMessages(domain, baseUrl) {
    ...
    static getToegelatenOperaties(domain, baseUrl) {
        const url = baseUrl
...
//# sourceMappingURL=vl-proza-rest-client.util.js.map