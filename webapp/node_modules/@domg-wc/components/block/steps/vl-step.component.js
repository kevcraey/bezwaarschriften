...
let VlStepComponent = class VlStepComponent extends BaseLitElement {
    constructor() {
        super(...arguments);
        // Attributen
        this.type = null;
        ...
        // Private properties
        this.isTitleAnnotationSlotAssigned = true;
        this.customCSSStyleSheet = new CSSStyleSheet();
    }
    static get styles() {
    ...
    firstUpdated(changedProperties) {
        ...
        if (this.toggleable) {
            ...
            if (!isAccordionDressed) {
                ...
                this.shadowRoot?.querySelector('slot[name="title"]')?.addEventListener('click', (event) => {
                    event.stopPropagation();
                    this.shadowRoot?.querySelector('button.js-vl-accordion__toggle')?.click();
                });
            }
        }
        const titleAnnotationSlot = this.shadowRoot?.querySelector('slot[name="title-annotation"]');
        this.isTitleAnnotationSlotAssigned =
            (titleAnnotationSlot && titleAnnotationSlot.assignedNodes().length > 0) || false;
    }
    getStepHeaderTemplate() {
    ...
    getAccordionStepHeaderTemplate() {
        const stepHeaderTitleTemplate = this.getStepHeaderTitleTemplate();
        return html `
...
VlStepComponent = __decorate([
    customElement('vl-step')
], VlStepComponent);
export { VlStepComponent };
//# sourceMappingURL=vl-step.component.js.map