...
let VlSearchComponent = class VlSearchComponent extends BaseHTMLElement {
    constructor() {
        const html = `
            <div class="vl-search">
...
VlSearchComponent = __decorate([
    webComponent('vl-search'),
    __metadata("design:paramtypes", [])
], VlSearchComponent);
export { VlSearchComponent };
//# sourceMappingURL=vl-search.component.js.map