...
import { CASCADER_MESSAGES, CASCADER_SLOTS } from './vl-cascader.model';
import { defaultItemActionTemplate, getDefaultItemTemplate, getTemplateFunctionForType } from './vl-cascader.utils';
let VlCascaderItemComponent = class VlCascaderItemComponent extends BaseLitElement {
    constructor() {
        super(...arguments);
        this.item = { label: CASCADER_MESSAGES.LABEL_MISSING };
        this.label = CASCADER_MESSAGES.LABEL_MISSING;
    }
...
VlCascaderItemComponent = __decorate([
    customElement('vl-cascader-item')
], VlCascaderItemComponent);
export { VlCascaderItemComponent };
//# sourceMappingURL=vl-cascader-item.component.js.map