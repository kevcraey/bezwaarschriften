...
let VlSideSheet = class VlSideSheet extends BaseHTMLElement {
    ...
    _tooltipTextChangedCallback(oldValue, newValue) {
    ...
    _hideToggleButtonChangedCallback(oldValue, newValue) {
    ...
    _customIconChangedCallback(oldValue, newValue) {
        if (newValue) {
...
VlSideSheet = __decorate([
    webComponent('vl-side-sheet'),
    __metadata("design:paramtypes", [Object])
], VlSideSheet);
export { VlSideSheet };
//# sourceMappingURL=vl-side-sheet.component.js.map