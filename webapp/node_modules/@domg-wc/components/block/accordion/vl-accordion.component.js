...
import { BaseHTMLElement, legacyBreakpoint, legacyCore, PADDINGS, registerWebComponents, webComponent, } from '@domg-wc/common';
...
let VlAccordionComponent = class VlAccordionComponent extends BaseHTMLElement {
    ...
    connectedCallback() {
        ...
        */
        this._buttonElement?.addEventListener('click', () => {
            this.dispatchEvent(new CustomEvent('vl-on-toggle', {
                detail: {
                    open: this._isOpen,
                },
            }));
    ...
    _contentPaddingChangedCallback(oldValue, newValue) {
...
//# sourceMappingURL=vl-accordion.component.js.map