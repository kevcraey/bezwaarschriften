...
import { BaseHTMLElement, findDeepestElementThroughShadowRoot, GlobalStyles, MARGINS, registerWebComponents, webComponent, } from '@domg-wc/common';
...
let VlFunctionalHeaderComponent = class VlFunctionalHeaderComponent extends BaseHTMLElement {
    constructor() {
        super(`
        ...
        `);
        this._backLinkEventListener = null;
        this._subTitleListElement = null;
    }
    ...
    connectedCallback() {
        ...
        if (this._backLinkElement) {
            ...
            this._backLinkElement.onclick = (event) => this._handleClickBackLink(event);
        }
        if (this.shadowRoot) {
    ...
    _marginBottomChangedCallback(oldValue, newValue) {
    ...
    _hideBackLinkChangedCallback(oldValue, newValue) {
        if (newValue != undefined) {
            this._backLinkContainer?.remove();
        }
    }
    _hideSubHeaderChangedCallback(oldValue, newValue) {
        if (newValue != undefined) {
    ...
    _handleClickBackLink(event) {
        if (this.hasAttribute('disable-back-link')) {
            event.preventDefault();
        }
        this.dispatchEvent(new CustomEvent('vl-click-back', {
            bubbles: true,
            composed: true,
        }));
    }
...
VlFunctionalHeaderComponent = __decorate([
    webComponent('vl-functional-header'),
    __metadata("design:paramtypes", [])
], VlFunctionalHeaderComponent);
export { VlFunctionalHeaderComponent };
//# sourceMappingURL=vl-functional-header.component.js.map