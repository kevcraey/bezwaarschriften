...
let VlPopoverComponent = class VlPopoverComponent extends BaseLitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.for = popoverDefaults.for; // html id van het referentie-element
        this.trigger = popoverDefaults.trigger;
        this.placement = popoverDefaults.placement;
        this.distance = popoverDefaults.distance; // afstand van referentie-element in px
        this.hideArrow = popoverDefaults.hideArrow;
        this.contentPadding = popoverDefaults.contentPadding;
        this.hideOnClick = popoverDefaults.hideOnClick;
        this.strategy = popoverDefaults.strategy;
        this.show = () => {
            this.open = true;
        };
        this.hide = () => {
...
VlPopoverComponent = __decorate([
    customElement('vl-popover')
], VlPopoverComponent);
export { VlPopoverComponent };
//# sourceMappingURL=vl-popover.component.js.map