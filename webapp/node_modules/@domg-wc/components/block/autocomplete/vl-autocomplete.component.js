...
let VlAutocomplete = class VlAutocomplete extends BaseLitElement {
    static get styles() {
    ...
    updated(changed) {
        ...
        if ((changed.has('opened') || changed.has('firstValidItemIndex')) &&
            this.opened &&
            _suggestionEl &&
...
export { VlAutocomplete };
//# sourceMappingURL=vl-autocomplete.component.js.map