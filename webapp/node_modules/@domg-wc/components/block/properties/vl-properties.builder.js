const cloneChildNodes = (childNodes) => childNodes.map((node) => node.cloneNode(true));
const buildItems = (elements) => {
    const items = [];
    let labels = [], data = [];
...
export const buildProperties = (elements) => {
