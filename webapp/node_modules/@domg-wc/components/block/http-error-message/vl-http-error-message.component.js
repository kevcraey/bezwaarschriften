...
let VlHttpErrorMessage = class VlHttpErrorMessage extends BaseHTMLElement {
    constructor() {
        const html = `
    ...
    __hasSlot(element, slotName) {
        const slotElement = element.querySelector(`slot[name=${slotName}]`);
...
VlHttpErrorMessage = __decorate([
    webComponent('vl-http-error-message'),
    __metadata("design:paramtypes", [])
], VlHttpErrorMessage);
export { VlHttpErrorMessage };
//# sourceMappingURL=vl-http-error-message.component.js.map