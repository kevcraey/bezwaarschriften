...
let VlCheckboxComponent = class VlCheckboxComponent extends FormControl {
    constructor() {
        super(...arguments);
        // Attributes
        this.block = checkboxDefaults.block;
        this.value = checkboxDefaults.value;
        this.checked = checkboxDefaults.checked;
        this.isSwitch = checkboxDefaults.isSwitch;
        // Variables
        this.initialValue = null;
        this.initialCheckedValue = false;
...
VlCheckboxComponent = __decorate([
    webComponent('vl-checkbox')
], VlCheckboxComponent);
export { VlCheckboxComponent };
//# sourceMappingURL=vl-checkbox.component.js.map